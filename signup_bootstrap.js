...
var $author$project$SignupWithBootstrap$init = {email: '', loggedIn: false, name: '', password: ''};
...
var $author$project$SignupWithBootstrap$view = function (user) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$SignupWithBootstrap$main = $author$project$SignupWithBootstrap$view($author$project$SignupWithBootstrap$init);
_Platform_export({'SignupWithBootstrap':{'init':_VirtualDom_init($author$project$SignupWithBootstrap$main)(0)(0)}});}(this));